...
var ap5 = new APlayer({
    ...
    music: [
		...
		title: 'Hide (Tropkillaz Remix)',
	  	author: 'N.A.S.A',
	  	url: './betaM/traplord/01Hide(TropkillazRemix)[feat.AynzliJones].m4a',
	  	pic: './betaM/traplord/2.jpg',
	  	lrc: ""
	  },
        {//
		title: ' Two Drags',
            author: 'Tropkillaz',
    		url: './betaM/traplord/Two_Drags.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },
	  {//
		title: ' We Like To Party (NGHTMRE Remix)',
            author: 'Showtek',
    		url: './betaM/traplord/WeLikeToParty(Slander&NGHTMREFestivalTrapEdit).mp3',
            pic: './betaM/traplord/st.jpg',
            lrc: ""
	},{//
		title: ' How We Do',
            author: 'Showtek',
    		url: './betaM/traplord/25_How_We_Do.mp3',
            pic: './betaM/traplord/st.jpg',
            lrc: ""
	},{//
		title: ' Assests (feat. The Kemist)',
            author: 'Tropkillaz',
    		url: './betaM/traplord/Assets_(feat._The Kemist).m4a',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
	},{//
		title: ' Bad (feat. Vassy)',
            author: 'David Guetta',
    		url: './betaM/traplord/Badft.Vassy.m4a',
            pic: './betaM/traplord/bad.jpg',
            lrc: ""
	},{////////////
		title: ' Bap U',
            author: 'Party Favor',
    		url: './betaM/betaM/traplord/BapU.mp3',
            pic: './betaM/traplord/pf.jpg',
            lrc: ""
        },{////////////
		title: ' Boa Noite',
            author: 'Tropkillaz',
    		url: './betaM/traplord/BoaNoite.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: ' Bricks (feat. Migos)',
            author: 'DJ Carnage',
    		url: './betaM/traplord/Bricks(Feat.Migos).mp3',
            pic: './betaM/traplord/dc.jpeg',
            lrc: ""
        },{////////////
		title: 'Hardcore',
            author: 'Tropkillaz',
    		url: './betaM/traplord/HARDCORE.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: 'Hate Being (Dotcom Remix)',
            author: 'Chief Keef',
    		url: './betaM/traplord/HateBeingSober(DotcomsFestivalTrapRemix).mp3',
            pic: './betaM/traplord/ck.jpg',
            lrc: ""
        },{////////////
		title: 'HIDEHO',
            author: 'Tropkillaz',
    		url: './betaM/traplord/HIDEHO.m4a',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: 'Hot Damn',
            author: 'Tropkillaz',
    		url: './betaM/traplord/HotDamn.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: 'I Want U',
            author: 'Alison Wonderland',
    		url: './betaM/traplord/IWantU.mp3',
            pic: './betaM/traplord/iwu.jpeg',
            lrc: ""
        },{////////////
		title: 'I\'m Blue (Trap Remix)',
            author: 'Effel 65',
    		url: './betaM/traplord/ImBlue(TrapRemix).mp3',
            pic: './betaM/traplord/et.jpg',
            lrc: ""
        },{////////////
		title: 'IBETCHU',
            author: 'Yellow Claw & Cesqeaux',
    		url: './betaM/traplord/IBETCHU.mp3',
            pic: './betaM/traplord/yc.jpg',
            lrc: ""
        },{////////////
		title: 'LOKO (Original Mix)',
            author: 'LOOKAS',
    		url: './betaM/traplord/LOKO(OriginalMix).mp3',
            pic: './betaM/traplord/la.png',
            lrc: ""
        },{////////////
		title: 'MAMBO',
            author: 'Tropkillaz',
    		url: './betaM/traplord/MAMBO.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: 'One Here Comes The Two',
            author: 'Tropkillaz',
    		url: './betaM/traplord/OneHereComesTheTwo.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: 'Rollup (Baauer Remix)',
            author: 'Flosstradamus',
    		url: './betaM/traplord/Rollup(BaauerRemix).m4a',
            pic: './betaM/traplord/fm.jpg',
            lrc: ""
        },{////////////
		title: 'Sixes',
            author: 'thefaded',
    		url: './betaM/traplord/Sixes.mp3',
            pic: './betaM/traplord/tf.jpg',
            lrc: ""
        },{////////////
		title: 'Take You There (feat. Kiesza)',
            author: 'Skrillex & Diplo',
    		url: './betaM/traplord/TakeUThere(Feat.Kiesza).mp3',
            pic: './betaM/traplord/sd.jpg',
            lrc: ""
        },{////////////
		title: 'Turn Up (Kill The Noise Remix)',
            author: 'Gent & Jawns',
    		url: './betaM/traplord/TurnUp(KillTheNoiseRemix).m4a',
            pic: './betaM/traplord/gj.jpg',
            lrc: ""
        },{////////////
		title: 'Way Up',
            author: 'Tropkillaz',
    		url: './betaM/traplord/WayUp.mp3',
            pic: './betaM/traplord/1.jpg',
            lrc: ""
        },{////////////
		title: 'GP (Original Version)',
            author: 'Paradise',
    		url: './betaM/traplord/ItsAGangsterParty2.mp3',
            pic: './betaM/traplord/gp.jpeg',
            lrc: ""
        }
